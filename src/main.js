...
window.render_game_to_text = () => {
    ...
    const strength = playerStrengthBreakdown(save.player);
    return JSON.stringify({
        ...
        player: {
            ...
            combatValue: strength.total,
            combatValueBreakdown: {
                ship: strength.shipValue,
                equipment: strength.equipmentValue,
                cash: strength.cashValue,
                cargo: strength.cargoValue,
            },
