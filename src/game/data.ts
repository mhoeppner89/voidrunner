...
export const GUILD_RANK_NAMES: Record<GuildId, string[]> = {
...
export const DOCK_LOCATION_IDS: DockLocationId[] = ['helix', 'rook', 'vesper', 'azure'];
export const NAV_LOCATION_IDS: LocationId[] = ['helix', 'rook', 'vesper', 'azure', 'shardbelt', 'mourning-line'];
...
export const LOCATION_ORDER: LocationId[] = ['helix', 'rook', 'azure', 'shardbelt', 'vesper', 'mourning-line'];

export const commodityIds = Object.keys(COMMODITIES) as CommodityId[];
export const equipmentIds = Object.keys(EQUIPMENT) as EquipmentId[];

export const locationByDockId = (id: DockLocationId) => LOCATIONS[id];
