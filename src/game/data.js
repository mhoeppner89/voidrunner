...
const helixPeople = [
    {
        id: 'mara-vek',
        name: 'Mara Vek',
        relationship: 'Your aunt · your mother’s sister',
    ...
    },
    {
        ...
        role: 'Pilot of the Second Light',
        affiliation: 'Vek family',
        portraitSeed: 18,
        lines: [
...
export const EQUIPMENT = {
    ...
    'pdc-cluster': {
        ...
        category: 'weapon',
        price: 4400,
        description: 'Prioritises incoming missiles. Fires ten-round bursts at your selected hostile within 90 units; weak against shields, effective against exposed hull.',
        stat: 'Missile priority · 90u range · 10-round bursts',
    },
    'ripper-scattergun': {
...
export const SHIPS = {
    ...
    vanguard: {
        ...
        price: 48500,
        description: 'A heavy escort with broad turret coverage and substantial cargo space. Its mass limits acceleration and turning.',
        maxSpeed: 48,
        afterburnSpeed: 72,
        acceleration: 17,
    ...
    talon: {
        ...
        afterburnSpeed: 128,
        acceleration: 46,
        angularAcceleration: 4.4,
        angularDamping: 3.15,
        lateralMultiplier: 1.2,
        shield: 130,
        hull: 170,
        reactorOutput: 26,
        energyCapacity: 80,
    ...
    lancer: {
        ...
        afterburnSpeed: 105,
        acceleration: 38,
        angularAcceleration: 4.05,
        lateralMultiplier: 1.12,
        angularDamping: 3.05,
        shield: 140,
        hull: 260,
        reactorOutput: 30,
