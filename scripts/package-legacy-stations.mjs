...
const tint={'Pale scientific ceramic':[.74,.79,.82,1],'Warm ceramic armor':[.66,.61,.48,1],'Blue grey structural steel':[.27,.34,.39,1],'Oxide red refinery cladding':[.42,.15,.075,1],'Ochre docking identification':[.8,.48,.08,1]};
for(const id of ['helix', 'rook', 'cairn', 'argent', 'gatehouse-twelve', 'blackglass', 'cinder', 'torchwell', 'nacre', 'shepherd']){
...
}await fs.writeFile('.freebuff/station-rebuild/asset-report.json',JSON.stringify(report,null,2));console.log(report);
